...
const DISTORSIONES: Distorsion[] = [
  ...
  {
    key: "conclusiones-precipitadas",
    numero: "5.5",
    titulo: "Conclusiones precipitadas",
    pregunta: "¿Sacas conclusiones negativas sin pruebas suficientes?",
    explicacion: "Incluye dos formas: (a) lectura del pensamiento — asumir lo que otros piensan de ti — y (b) anticipación negativa — predecir un mal desenlace sin evidencia.",
    ejemplo: "Ejemplo: «Está callado, seguro está enojado conmigo» o «Sé que el examen me va a salir mal».",
    acento: PALETTE.rosa,
  },
  {
